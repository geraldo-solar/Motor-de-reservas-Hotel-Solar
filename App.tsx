  ...
  return (
    <div className={`min-h-screen font-sans ${currentView === ViewState.THANK_YOU ? 'bg-transparent p-0' : 'bg-[#F9F8F6] pb-24'} relative`}>
      ...
      {currentView !== ViewState.ADMIN && (
        <a
          href="https://wa.me/5591981229825?text=Quero%20mais%20informa%C3%A7%C3%B5es"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-4 shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center group"
        ...
        >
          ...
          <span className="hidden md:block absolute right-full mr-3 bg-[#0F2820] text-white px-3 py-2 rounded-lg text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
